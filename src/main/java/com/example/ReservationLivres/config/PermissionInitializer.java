package com.example.ReservationLivres.config;
...
public class PermissionInitializer implements ApplicationRunner {
    ...
    private final AppUserRepository userInfoRepository;
    private final PasswordEncoder passwordEncoder;

    @Autowired
    public PermissionInitializer(PermissionRepository permissionRepository, RoleRepository roleRepository,
                                 AppUserRepository userInfoRepository, PasswordEncoder passwordEncoder) {
    ...
    public void run(ApplicationArguments args) {
        String[] perm_list = { "list_role", "view_role", "create_role", "update_role", "delete_role",
                ...
                "create_permission", "update_user_password", "get_profile", "update_profile", "create_livre",
                "view_livre", "update_livre", "delete_livre", "view_reservation", "create_reservation",
