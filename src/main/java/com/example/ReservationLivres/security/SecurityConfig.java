package com.example.ReservationLivres.security;
...
//
           .authorizeHttpRequests()
                .requestMatchers(HttpMethod.GET, "/api/livre/**").hasAnyAuthority("view_livre")
                .requestMatchers(HttpMethod.POST, "/api/livre").hasAuthority("create_livre")
                .requestMatchers(HttpMethod.PUT, "/api/livre/**").hasAuthority("update_livre")
                .requestMatchers(HttpMethod.DELETE, "/api/livre/**").hasAuthority("delete_livre")

                .requestMatchers(HttpMethod.GET, "/api/reservation/**").hasAnyAuthority("view_reservation")
                .requestMatchers(HttpMethod.POST, "/api/reservation").hasAuthority("create_reservation")
                .requestMatchers(HttpMethod.PUT, "/api/reservation/**").hasAuthority("update_reservation")
                .requestMatchers(HttpMethod.DELETE, "/api/reservation/**").hasAuthority("delete_reservation")
